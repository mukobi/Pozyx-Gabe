...
void draw(){
    background(126,161,172); // sets background color of whole window to dull blue
       
    // show some text
    // the fill function sets the color used to fill shapes
    // this sets everything below it to be filled in black
    fill(0,0,0);
    // adds copyright text 100 pixels from the right and 20 pixels from the top of the window
