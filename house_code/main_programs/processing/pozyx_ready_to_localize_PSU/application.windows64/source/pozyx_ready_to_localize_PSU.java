...
public class pozyx_ready_to_localize_PSU extends PApplet {
...
public void keyPressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "pozyx_ready_to_localize_PSU" };
    if (passedArgs != null) {
