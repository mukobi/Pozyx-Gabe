...
if  __name__ == "__main__":
    ...
    remote_id = 0x6103                 # remote device network ID
    ...
    anchors = [DeviceCoordinates(0x6020, 1, Coordinates(9120, 6210, 2380)),
               DeviceCoordinates(0x605d, 1, Coordinates(3920, 9950, 1945)),
               DeviceCoordinates(0x604f, 1, Coordinates(0, 5110, 2385)),
               DeviceCoordinates(0x6863, 1, Coordinates(3110, 0, 100)),
               DeviceCoordinates(0x6129, 1, Coordinates(6270, 0, 2670)),
               DeviceCoordinates(0x607c, 1, Coordinates(3860 ,5700, 2860))]
